...
// Add floating WhatsApp button pulse on page load
window.addEventListener('load', () => {
    const floatingWa = document.querySelector('.floating-wa');
    if (floatingWa) {
        setTimeout(() => {
            floatingWa.style.animation = 'pulse 2s infinite';
        }, 1000);
    }
});

console.log('Pecel Lele Maharani - Website loaded successfully! 🍽️');